...
```bash
curl -X POST "https://evilan.onrender.com/api/generate-code" \
...
Evilan's code generation follows these principles:
...
```javascript
const response = await fetch('https://evilan.onrender.com/api/generate-code', {
  method: 'POST',
