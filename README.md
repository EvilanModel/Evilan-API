...
The Evilan AI API provides developers with direct access to our intelligent assistant infrastructure. Powered by GPT-4o and ElevenLabs, Evilan can engage in natural conversations, generate production-ready code, and provide high-quality voice synthesis.

**Base URL:** `https://evilan.onrender.com`
...
To get started with the Evilan AI API:
...
```bash
curl -X POST https://evilan.onrender.com/api/chat \
...
Engage in natural conversations with Evilan AI assistant.
...
```json
{
  "response": "I'm Evilan, a friendly AI assistant created to help you...",
  "usage": {
    "prompt_tokens": 45,
...
- **Website:** [https://evilanai.xyz](https://evilanai.xyz)
- **GitHub:** [https://github.com/EvilanModel/Evilan-API](https://github.com/EvilanModel/Evilan-API)
- **Twitter:** [https://x.com/EvilanAI](https://x.com/EvilanAI)
- **Health Check:** [https://evilan.onrender.com/health](https://evilan.onrender.com/health)

## Support

For support, questions, or feature requests:

- Open an issue on [GitHub](https://github.com/EvilanModel/Evilan-API)
- Follow us on [Twitter](https://x.com/EvilanAI)
- Visit our website at [evilanai.xyz](https://evilanai.xyz)
