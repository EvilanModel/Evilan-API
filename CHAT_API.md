...
The Chat API allows you to have natural conversations with Evilan AI assistant powered by GPT-4o.

## Endpoints

### POST /api/chat

Send a message to Evilan and receive a conversational response with context awareness.
...
|-----------|------|----------|-------------|
| message | string | Yes | The user's message to send to Evilan |
...
```json
{
  "response": "I'm Evilan, a friendly and intelligent AI companion created by talented developers who wanted to make AI assistance more personal and friendly. I'm here to help you with various tasks, answer questions, or just have a nice conversation!",
  "usage": {
    "prompt_tokens": 45,
...
|-------|------|-------------|
| response | string | Evilan's response message |
...
Evilan uses the following personality traits:
...
```javascript
const response = await fetch('https://evilan.onrender.com/api/chat', {
  method: 'POST',
